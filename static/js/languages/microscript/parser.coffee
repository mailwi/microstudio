...
#      if Program.Precedence[op.operation]>=Program.Precedence[op.term2.operation]
#        opa = new Program.Operation operation,operation.value,term1,op.term2.term1
#        opb = new Program.Operation op.token,op.term2.operation,opa,op.term2.term2
#        op = opb
#    op
